    ...
    <TouchableHighlight
      ...
      <View style={[styles.MessageRow]}>
        ...
        <View style= {[styles.messageSection,]}  >
          ...
          <Text style={{width: '80%', height: '50%'}}>{item.data.lastMSg}</Text>
        </View>
        <View style={[styles.detailSection,{alignSelf:'flex-start'}]}>
          <Text>{msgTime}</Text>
          <View style={[styles.yellowBubble,{marginTop:10}]}>
            <Text style={styles.bubbleText}>12</Text>
          </View>
        </View>
